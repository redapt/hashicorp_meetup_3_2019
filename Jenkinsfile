pipeline{
    ...
    stages{
        ...
        stage("Setup Platform"){
            steps {
                withCredentials([
                    azureManagedIdentity(clientIdVariable: 'ARM_CLIENT_ID', clientSecretVariable: 'ARM_CLIENT_SECRET', credentialsId: 'azure_service_principal', subscriptionIdVariable: 'ARM_SUBSCRIPTION_ID', tenantIdVariable: 'ARM_TENANT_ID'), 
